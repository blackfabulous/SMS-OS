...
| Modules migrated to standard | All modules use typed data layer | In progress; reports service done; decomposition pilots completed for `timetable-module.tsx`, `sdc-module.tsx`, and `sms-dialog.tsx`. |

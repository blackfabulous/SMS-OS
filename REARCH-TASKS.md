...
| RA-D3 | **Module decomposition standard** — `page.tsx (server) + components/ + hooks/`, ≤~300 lines/file (current modules are 800–1,500). Pilots completed for `timetable-module.tsx`, `sdc-module.tsx`, `sms-dialog.tsx`, and `paynow-dialog.tsx` under `src/components/modules/`; remaining modules pending | P2 | XL | RA-D2 | No monolith module files |

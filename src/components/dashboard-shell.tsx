...
// ─── Dashboard Shell (authenticated SPA shell, driven by URL) ────────────────
export interface DashboardShellProps {
  moduleId: string
}

export default function DashboardShell({ moduleId }: DashboardShellProps) {
  ...
  const filteredNavGroups = useMemo(() => rbac.filterNavGroups(dashboardNavGroups), [rbac])
